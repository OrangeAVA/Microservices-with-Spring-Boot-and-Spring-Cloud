...
public class DoctorDAOImpl implements DoctorDAO {
	...
	public boolean updateSpecialization(int doctorId, String specialization) {
		boolean isUpdated = false;
		String UPDATE_DOCTOR = "update doctor set specialization=? where doctorId=?";
	...
	public Doctor findDoctorById(int doctorId) {
		Doctor doctor = null;
		String FINDDOCTORBYID = "select * from doctor where doctorId=?";
	...
	public List<Doctor> findAllDoctorsBySpecialization(String specialization) {
		...
		if (specialization != null) {
			String FIND_DOCTOR_BY_ID = "select * from doctor where specialization=?";
